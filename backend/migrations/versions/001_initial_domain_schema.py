...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('shot_type', sa.String(length=50), nullable=False, server_default='AI_GENERATED'),
    ...
    op.create_table(
        ...
        sa.Column('provider_name', sa.String(length=50), nullable=False, server_default='vidu'),
