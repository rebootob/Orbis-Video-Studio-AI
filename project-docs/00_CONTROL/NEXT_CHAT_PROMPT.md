...
- Canonical main SHA: fresh-fetch from GitHub repository truth (RUN1-CLOSE authorized base: 04909d7e1f89af25d7d47615775e496948303fd5)
...
2. Read from the freshest applicable ref in this order:
   ...
   project-docs/40_DELIVERY/P4_WP020_LIVE_R5_VIDU2_PF1_CLOSE.md
   project-docs/40_DELIVERY/P4_WP020_LIVE_R5_VIDU2_RUN1_CLOSE.md
...
- PREV2_COMPLETED_GATE = P4-WP020-LIVE-R5-VIDU2-PF1 (Run 34501285649)
