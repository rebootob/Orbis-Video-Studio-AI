...
CURRENT_GATE: P4-WP019 / IMPLEMENTATION
...
3. `P4-WP019 = IN_PROGRESS / IMPLEMENTATION`.
4. `IMPLEMENTATION_AUTHORIZED = YES`.
5. `P4-WP020 = PROPOSED / NOT AUTHORIZED`.
6. Implement locked P4-WP019 scope per PRE1 specification.
7. Deliver full test suite and validation.
8. Antigravity = bounded low-credit Execution Plane.
9. Codex = STOP.
10. Claude Code = STOP.
