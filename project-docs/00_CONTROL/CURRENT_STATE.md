...
>
> This specification records canonical state effective for P4-WP020-LIVE-R5-VIDU2-PREP-CLOSE on canonical `main` `fb72d683c0dd4daa721507b6a0c12dcec17d7366`.
...
PREV3_COMPLETED_GATE: P4-WP020-LIVE-R5-VIDU1-COR1
PREV3_COMPLETED_STATUS: PASS / MERGED / COMPLETE (PR #93)
PREV4_COMPLETED_GATE: P4-WP020-LIVE-R5-VIDU1-PREP
