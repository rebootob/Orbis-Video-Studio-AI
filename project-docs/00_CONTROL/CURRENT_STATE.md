...
>
> This specification records canonical state effective for P4-WP020-LIVE-R5-VIDU2-PREP-CLOSE (closure base main: `fb72d683c0dd4daa721507b6a0c12dcec17d7366`).
> Post-merge canonical HEAD must be fresh-fetched from GitHub repository truth.
...
CLOSURE_BASE_MAIN_SHA: fb72d683c0dd4daa721507b6a0c12dcec17d7366
AUTHORIZATION_MAIN_SHA: fb72d683c0dd4daa721507b6a0c12dcec17d7366
IN_FLIGHT_CLOSURE_PR: #97 (OPEN / IN REVIEW / NOT MERGED)
IN_FLIGHT_CLOSURE_BRANCH: ai/p4-wp020-live-r5-vidu2-prep-close
IN_FLIGHT_CLOSURE_AUTH_COMMENT: 5617902191
...
PREV3_COMPLETED_STATUS: PASS / MERGED / COMPLETE (PR #93)
PREV4_COMPLETED_GATE: P4-WP020-LIVE-R5-VIDU1-PREP (PR #92)
PREV4_COMPLETED_STATUS: PASS / MERGED / COMPLETE (PR #92)
PREV5_COMPLETED_GATE: P4-WP020-LIVE-R5-PRE1-CLOSE-R1 (PR #91)
PREV5_COMPLETED_STATUS: PASS / MERGED / COMPLETE (PR #91)

# POST-MERGE TARGET (CANONICAL STATE AFTER PR #97 MERGE)
POST_MERGE_P4-WP020-LIVE-R5-VIDU2-PREP-CLOSE: PASS / MERGED / COMPLETE
...
POST_MERGE_LAST_COMPLETED_GATE: P4-WP020-LIVE-R5-VIDU2-PREP-CLOSE
POST_MERGE_LAST_COMPLETED_STATUS: PASS / MERGED / COMPLETE (PR #97)
POST_MERGE_PREV_COMPLETED_GATE: P4-WP020-LIVE-R5-VIDU2-PREP (PR #96)
POST_MERGE_PREV2_COMPLETED_GATE: P4-WP020-LIVE-R5-VIDU1-C1-CLOSE (PR #95)
POST_MERGE_PREV3_COMPLETED_GATE: P4-WP020-LIVE-R5-VIDU1-C1 (PR #94)
POST_MERGE_PREV4_COMPLETED_GATE: P4-WP020-LIVE-R5-VIDU1-COR1 (PR #93)
POST_MERGE_PREV5_COMPLETED_GATE: P4-WP020-LIVE-R5-VIDU1-PREP (PR #92)
POST_MERGE_PREV6_COMPLETED_GATE: P4-WP020-LIVE-R5-PRE1-CLOSE-R1 (PR #91)
