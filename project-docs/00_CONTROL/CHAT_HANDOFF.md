...
BRANCH = ai/p4-wp020-live-r5-vidu2-run1-close
...
PREV2_COMPLETED_GATE = P4-WP020-LIVE-R5-VIDU2-PF1 (PR #99, Run 34501285649)
PREV3_COMPLETED_GATE = P4-WP020-LIVE-R5-VIDU2-PF1-COR1 (PR #98)
PREV4_COMPLETED_GATE = P4-WP020-LIVE-R5-VIDU2-PREP-CLOSE (PR #97)
PREV5_COMPLETED_GATE = P4-WP020-LIVE-R5-VIDU2-PREP (PR #96)
PREV6_COMPLETED_GATE = P4-WP020-LIVE-R5-VIDU1-C1-CLOSE (PR #95)
...
Next Gate Direction:
- Current in-flight gate: `P4-WP020-LIVE-R5-VIDU2-RUN1-CLOSE` (PR OPEN / IN REVIEW / NOT MERGED).
...
> [!NOTE]
> This section is an execution-flight reference for the P4-WP020-LIVE-R5-VIDU2-RUN1-CLOSE review/merge gate only.
