...
CANONICAL_BASE_MAIN = 817539b619c4b28f22273ff01df733c612a2a386
NEXT_GATE = OWNER DECISION REQUIRED

LAST_COMPLETED_GATE = P4-WP020-LIVE-R5-PRE1-CLOSE
LAST_COMPLETED_STATUS = PASS / MERGED / COMPLETE
CLOSURE_AUTH_COMMENT = 5601980565
CLOSURE_MERGE_PR = #90
CLOSURE_MERGE_COMMIT = 817539b619c4b28f22273ff01df733c612a2a386
...
With R5-PRE1-CLOSE merged to canonical `main`:
- `ACTIVE_WORK_PACKAGE = NONE`;
- `NEXT_GATE = OWNER DECISION REQUIRED`.
