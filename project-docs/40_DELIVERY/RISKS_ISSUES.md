...
> **Canonical Document Location:** [`project-docs/40_DELIVERY/RISKS_ISSUES.md`](file:///c:/Users/allda/Desktop/Dev/git/Orbis%20Video%20Studio%20AI/project-docs/40_DELIVERY/RISKS_ISSUES.md)
...
| **R-05** | **Cloud Rendering Bottlenecks:** Heavy FFmpeg encoding jobs stall user preview workflows. | **LOW** | Offload video compositing to asynchronous cloud FFmpeg worker pools; render low-res proxies for browser timeline preview. |
